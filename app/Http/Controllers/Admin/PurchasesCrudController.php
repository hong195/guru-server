...
class PurchasesCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/purchases');
        CRUD::setEntityNameStrings('purchases', 'purchases');
    }
